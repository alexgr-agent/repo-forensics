...
for marker in ".codex-plugin/plugin.json" ".claude-plugin/plugin.json" ".cursor-plugin/plugin.json" ".kimi-plugin/plugin.json" "skills/repo-forensics/SKILL.md" "skills/forensify/SKILL.md" "hooks/hooks.json"; do
...
# Same reasoning for the Kimi Code manifest.
